...
class GPT(nn.Module):
    ...
    def __init__(self, vocab_size: int, context_length: int, model_dim: int, num_blocks: int, num_heads: int):
        ...
        self.embedding_layer = nn.Embedding(num_embeddings=vocab_size, embedding_dim=model_dim)
